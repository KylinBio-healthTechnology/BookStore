...
/**
 * Servlet implementation class bookdelectServlet
 */
@WebServlet("/admin/bookdelectServlet")
public class bookdelectServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect("http://localhost:8080/bookstore/admin/manage-book-delete.jsp");  //÷ÿ∂®œÚ
	}
